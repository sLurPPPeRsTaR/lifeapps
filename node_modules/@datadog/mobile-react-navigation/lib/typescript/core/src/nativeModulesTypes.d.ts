 ...
 */
export declare class DdNativeSdkConfiguration {
    ...
    constructor(clientToken: string, env: string, applicationId: string, nativeCrashReportEnabled: boolean, sampleRate: number, site: string, trackingConsent: string, additionalConfig: object);
}
/**
 * The entry point to initialize Datadog's features.
 */
export declare type DdNativeSdkType = {
    /**
 ...
 */
export declare type DdNativeLogsType = {
    /**
 ...
 */
export declare type DdNativeTraceType = {
    /**
 ...
 */
export declare type DdNativeRumType = {
    /**
     ...
     */
    startAction(type: ActionType, name: string, context?: object, timestampMs?: number): Promise<void>;
    /**
     ...
     */
    stopAction(type: ActionType, name: string, context?: object, timestampMs?: number): Promise<void>;
    /**
     * Add a RUM Action.
     * @param type: The action type (tap, scroll, swipe, back, custom).
     * @param name: The action name.
     ...
     */
    addAction(type: ActionType, name: string, context?: object, timestampMs?: number): Promise<void>;
    /**
...
declare type ActionType = 'TAP' | 'SCROLL' | 'SWIPE' | 'BACK' | 'CUSTOM';
declare type ResourceKind = 'image' | 'xhr' | 'beacon' | 'css' | 'document' | 'fetch' | 'font' | 'js' | 'media' | 'other' | 'native';
declare type ErrorSource = 'NETWORK' | 'SOURCE' | 'CONSOLE' | 'WEBVIEW' | 'CUSTOM';
export {};
