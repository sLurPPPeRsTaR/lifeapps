...
const getJsxRuntime = () => {
  ...
  const [major, minor] = require('react/package.json').version.split('.'); // We need to check on the version of React before requiring 'react/jsx-runtime') as
...
exports.getJsxRuntime = getJsxRuntime;
...
//# sourceMappingURL=getJsxRuntime.js.map