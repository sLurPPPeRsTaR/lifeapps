...
exports.filterDevResource = void 0;
 ...
 */
const EXPO_DEV_LOGS_REGEX = new RegExp('^http://((10|172|192).[0-9]+.[0-9]+.[0-9]+|localhost):[0-9]+/logs$');
/**
 * This call is made every time the RN packager reloads the js in dev mode.
 */

const RN_PACKAGER_SYMBOLICATE_REGEX = new RegExp('^http://localhost:[0-9]+/symbolicate$');
const internalResourceBlocklist = [EXPO_DEV_LOGS_REGEX, RN_PACKAGER_SYMBOLICATE_REGEX];
/**
 * Filters RN symbolicate calls and Expo logs calls that happen only in dev.
 * @param resource RUMResource
 */

const filterDevResource = resource => {
...
exports.filterDevResource = filterDevResource;
//# sourceMappingURL=internalDevResourceBlocklist.js.map