...
_defineProperty(DdRumUserInteractionTracking, "eventsInterceptor", new NoOpEventsInterceptor());

_defineProperty(DdRumUserInteractionTracking, "originalCreateElement", React.createElement);

_defineProperty(DdRumUserInteractionTracking, "originalMemo", React.memo);
