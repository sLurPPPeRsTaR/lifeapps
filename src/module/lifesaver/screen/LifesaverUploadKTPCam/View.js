...
function LifesaverUploadKTPCam(props) {
  const {
    navigation,
    lang,
    updataAction,
  ...
  function renderImageInvalidModal() {
    return (
      <BottomSheet isVisible={isImageInvalidModal} swipeable={false}>
        <View>
  ...
  function renderCompareFailModal() {
    return (
      <BottomSheet isVisible={isCompareFailModalVisible} swipeable={false}>
...
export default LifesaverUploadKTPCam;

LifesaverUploadKTPCam.propTypes = {
