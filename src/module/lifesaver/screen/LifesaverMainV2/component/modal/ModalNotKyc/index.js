      ...
      <View>
        <Text style={style.mt16}>
          ...
          <Text
            ...
            {trans(locale, lang, 'selanjutnyaEKYC')}
          </Text>
        </Text>
        <View style={[style.mt24, style.mbMin16]}>
          <Button onPress={onEKYCPress} rounded="lg" type="linear-gradient">
...
export default ModalNotKyc;

ModalNotKyc.defaultProps = {
  colorScheme: 'light',
};

ModalNotKyc.propTypes = {
  lang: PropTypes.string.isRequired,
  colorScheme: PropTypes.string,
  isVisible: PropTypes.bool.isRequired,
  onClosePress: PropTypes.func.isRequired,
  onEKYCPress: PropTypes.func.isRequired,
