...
export default {
  ...
  continueHobby: 'Continue your hobbies safely with LifeSAVER protection',

  // Lifesaver
  protectYou:
    'Protect you in all kinds of activities, including travel and extreme sports.',

  // total claim
  totalClaim: 'Total Claims Paid ',
  ...
  mulai: 'Mulai',
  upgrade: 'Upgrade',
  alreadyProtected: `You're Already Protected`,
