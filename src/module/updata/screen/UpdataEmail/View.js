...
import { ArrowRight2, Handphone, Message, Pin } from 'ca-config/Svg';
    ...
    (act) => {
      if (act === SET_UPDATA_REQUEST_OTP_SUCCESS) {
        ...
        navigation.navigate(NAVIGATION.UPDATA.UpdataOtp, {
          ...
          otpType: reqOtpType,
          nextRoute: NAVIGATION.UPDATA.UpdataEmailEdit,
        });
      }
...
export default UpdataEmail;

UpdataEmail.propTypes = {
