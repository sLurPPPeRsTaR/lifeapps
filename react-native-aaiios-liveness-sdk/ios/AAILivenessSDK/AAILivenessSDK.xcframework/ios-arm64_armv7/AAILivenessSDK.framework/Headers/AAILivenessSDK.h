...
/// This method is similar to the method "initWithAccessKey:secretKey:market:", the only difference is that this method can specify whether the SDK is used as a global service,
/// @param accesskey accessKey
/// @param secretkey secretKey
/// @param market market
...
/// This method should be called before the AAILivenessViewController is initialized.
///
/// If this value is set to YES, SDK will detect  face occlusion  before entering the action. The default value is NO.
