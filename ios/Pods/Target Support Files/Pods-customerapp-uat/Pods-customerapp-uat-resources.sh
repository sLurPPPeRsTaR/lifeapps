...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../react-native-aaiios-liveness-sdk/ios/AAILivenessSDK/Resource/AAIAudio.bundle"
  install_resource "${PODS_ROOT}/../../react-native-aaiios-liveness-sdk/ios/AAILivenessSDK/Resource/AAIImgs.bundle"
  install_resource "${PODS_ROOT}/../../react-native-aaiios-liveness-sdk/ios/AAILivenessSDK/Resource/AAILanguageString.bundle"
  install_resource "${PODS_ROOT}/../../react-native-aaiios-liveness-sdk/ios/AAILivenessSDK/Resource/AAIModel.bundle"
fi
