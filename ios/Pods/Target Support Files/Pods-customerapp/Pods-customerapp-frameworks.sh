...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FBSDKGamingServicesKit/FBSDKGamingServicesKit.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/react-native-aaiios-liveness-sdk/AAILivenessSDK.framework"
fi
